...
## Motivation
As a passionate follower of the Formula 1 World Championship, I always wanted a more competitive sport since most of the time the results can be gussed by the middle of the season. FIA(Federation Internationale de l'Automobile) tries new regulations so i wanted to see if it has a impact or not. In this study I aim to improve my data analaysis skills through modeling, visualization and analysis. Also F1 is a datat driven engineering sport.
## Terminology of the sport for people who are not F1 fans
ATR:
Qualifying: 
Pole:
Constructor points:
